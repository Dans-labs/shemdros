...
public class FocusInterventionist implements Appendable
{
    ...
    /**
     * Intervenes in RenderObjects stream and places the attribute focus="true" if monad is within range of focusList monadSets.
     * 
     * @param wrapped the wrapped appendable.
     * @param focusElementPart the string that precedes the value of the monad given as attribute. example: "<w fm=".
     */
    ...
    public Appendable append(CharSequence csq) throws IOException
    {
        ...
        if (xml.startsWith(focusElementPart))
        {
            ...
            {                    
                wrapped
                    .append(xml.substring(0, f + (l+1)))
                    .append(" focus=\"true\"")
                    .append(xml.substring(f + (l+1)));
                return this;
            }
        }
        wrapped.append(csq);
